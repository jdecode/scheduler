    ...
    <div class="flex items-center min-w-6 mr-2 ">
        ...
        @if($theme_switcher)
            <div onclick="toggleDark()" title="Toggle dark/light mode : Shift+D" class="cursor-pointer pl-4">
                <x-svg-icon svg="night-mode" title="Switch to dark mode [Shift + D]" class="h-6 w-6 block dark:hidden stroke-black"></x-svg-icon>
                <x-svg-icon svg="night-mode" title="Switch to light mode [Shift + D]" class="h-6 w-6 hidden dark:block stroke-yellow-500"></x-svg-icon>
            </div>
        @endif
    </div>
</div>
